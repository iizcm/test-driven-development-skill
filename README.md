...
cp -r software-development/test-driven-development ~/.hermes/skills/software-development/test-driven-development/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/test-driven-development-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/test-driven-development-skill.git ~/.hermes/skills/software-development/test-driven-development/
```
...
```text
skill_view(name="software-development/test-driven-development")
```
...
```text
Use the test driven development skill to <describe your specific task here>
```
...
```text
Gunakan skill test driven development untuk <deskripsikan tugas spesifik Anda di sini>
```
